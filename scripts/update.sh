...
echo "Starting Bolt update process..."
...
LATEST_RELEASE_URL=$(curl -s https://api.github.com/repos/stackblitz-labs/bolt/releases/latest | grep "browser_download_url.*zip" | cut -d : -f 2,3 | tr -d \")
